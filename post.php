...
$thepermapost = $_SERVER['QUERY_STRING'];
if(empty($thepermapost)){header('Location: home');}
if(ctype_space($thepermapost)){header('Location: home');}
$theposttitle = theposttitlepage($_SERVER['QUERY_STRING']);
...
<html lang="en">
  <head>
    ...
    <title><?php echo $theposttitle; ?> | MeeTeam</title>
...
<!-- ### TOP MENU ### -->
     ...
     <div class="container">
       <div class="col-sm-9">
          ...
          <!-- ### COMMENT ### -->
          <div id="timeliner" style="margin-top:20px;z-index: 1;">

          <?php
             takepostperpermalink($thepermapost);
          ?>
       ...
       <div id="sidebar" class="col-sm-3" style="margin-top: 22px;">
