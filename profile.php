...
<html lang="en">
  <head>
    ...
    <title><?php echo $explodedata[1]; ?> | MeeTeam</title>
...
<!-- ### TOP MENU ### -->
     ...
     <div class="container">
       <div class="col-sm-9">
              ...
              <div class="row">
                ...
                <div class="col-sm-8 border-right">
                  <div class="description-block" style="text-align:center;">
                      <a href="profile.php?<?php echo $thepermauser; ?>" class="btn btn-sm btn-default active"><i class="fa fa-clock-o"></i> Timeline</a>
          ...
          <div id="timeliner">
             ...
             <?php takemylast6postprofile($explodedata[0]); ?>    
    ...
    <script type="text/javascript">
      <?php knowtimelinepostprofile($explodedata[0]); ?>
    </script>    
  </body>
</html>