              ...
              <div class="row">
                ...
                <div class="col-sm-8 border-right">
                  <div class="description-block" style="text-align:center;">
                      ...
                      <a href="home.php" class="btn btn-sm btn-success"><i class="fa fa-clock-o"></i> Timeline</a>
                      <a href="myinformation.php" class="btn btn-sm btn-info"><i class="fa fa-info-circle"></i> Información</a>
                      <a href="mypictures.php" class="btn btn-sm bg-navy active"><i class="fa fa-picture-o"></i> Fotos</a>
