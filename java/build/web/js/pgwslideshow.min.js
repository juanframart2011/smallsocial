(function (a) {
    a.fn.pgwSlideshow = function (q) {
        var i = {
            mainClassName: "pgwSlideshow", transitionEffect: "sliding", displayList: true, displayControls: true, touchControls: true, autoSlide: false, beforeSlide: false, afterSlide: false, maxHeight: null, adaptiveDuration: 200, transitionDuration: 500, intervalDuration: 3000
        };
        if (this.length == 0) {
            return this;
        }
        ...
        var p = function () {
            ...
            j.window.resize(function () {
                ...
                j.resizeEvent = setTimeout(function () {
                    ...
                    var r = j.plugin.find(".ps-current > ul > li.elt_" + j.currentSlide + " video").height();
                    h(r);
                    if (j.config.displayList) {
                        b();
                        n();
        ...
        var h = function (r, s) {
            ...
            if (typeof j.plugin.find(".ps-current").animate == "function") {
                j.plugin.find(".ps-current").stop().animate({height: r}, j.config.adaptiveDuration, function () {
                    if (j.config.maxHeight) {
                        j.plugin.find(".ps-current > ul > li img").css("max-height", r + "px");
                        j.plugin.find(".ps-current > ul > li video").css("max-height", r + "px");
                    }
                });
            } else {
        ...
        var g = function () {
            ...
            j.plugin.find(".ps-list > ul > li").each(function () {
                ...
                if (t.image) {
                    ...
                    if (t.thumbnail) {
                        ...
                        //Si se ha seleccionado un video, lo pone en grande
                        if(t.thumbnailvideo){
                            s.html('<video controls> <source src="' + t.thumbnailvideo + '" type="' + t.tipovideo + '" />  </video>');
                        }
                    }
                }
                if (t.link) {
            ...
            j.plugin.find(".ps-current > ul > li.elt_1 video").on("load", function () {
                e();
                var s = j.plugin.find(".ps-current > ul > li.elt_1 video").height();
                h(s);
            });
            e();
            j.plugin.show();
        ...
        var d = function (x) {
            ...
            //Para videos (Si hay un source con src y type)
            var sv = x.find("source").attr("src");
            if ((typeof sv != "undefined") && (sv != "")) {
                v.thumbnailvideo = sv;
            }
            var yv = x.find("source").attr("type");
            if ((typeof yv != "undefined") && (yv != "")) {
                v.tipovideo = yv;
            }
        ...
        var m = function (r) {
            ...
            var s = j.plugin.find(".ps-current .elt_" + r.id + " video").height();
            h(s, true);
            return true;
        };
        var f = function (u) {
            ...
            if (j.currentSlide > 0) {
                ...
                r.css("position", "absolute").animate({opacity: 0}, j.config.transitionDuration, function () {
            ...
            s.css("position", "absolute").show().animate({opacity: 1}, j.config.transitionDuration, function () {
        ...
        var o = function (v, y) {
            ...
            if (j.currentSlide == 0) {
                u.find(".elt_1").css({position: "", left: "", opacity: 1, "z-index": 2}).show();
                ...
                s.css("position", "absolute").animate({left: r}, j.config.transitionDuration, function () {
                ...
                t.css("position", "absolute").css("left", w).css("opacity", 1).show().animate({left: 0}, j.config.transitionDuration, function () {
        ...
        var b = function () {
            ...
            if (v > u) {
                ...
                w.find(".ps-prev").show().unbind("click").click(function () {
                    ...
                    if (typeof r.animate == "function") {
                        r.animate({left: x}, j.config.transitionDuration);
                    } else {
                        r.css("left", x);
                    }
                });
        ...
        j.reload = function (r) {
            ...
            j.window.resize(function () {
                ...
                j.resizeEvent = setTimeout(function () {
                    ...
                    var s = j.plugin.find(".ps-current > ul > li.elt_" + j.currentSlide + " video").css("max-height", "").height();
                    h(s);
                    if (j.config.displayList) {
                        b();
                        n();
