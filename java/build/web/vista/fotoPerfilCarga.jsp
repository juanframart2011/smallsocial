<%-- 
    Document   : fotoPerfilCarga
    Created on : 23-ene-2017, 17:10:02
    Author     : Orion
--%>
...
<html>
    ...
    <body>
        <%
            ...
            String rutaFicheros = "C:\\Users\\Borja\\Documents\\NetBeansProjects\\MeeTeam\\web\\imagenPerfil\\";
            ...
            try {
                ...
                boolean carga = bd.cargarImagenPerfil(codUsu, url);
