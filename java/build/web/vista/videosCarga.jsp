<%-- 
    Document   : videosCarga
    Created on : 23-feb-2017, 19:19:49
    Author     : Orion
--%>
...
<html>
    ...
    <body>
        <%
           ...
           String rutaFicheros ="C:\\Users\\Borja\\Documents\\NetBeansProjects\\MeeTeam\\web\\misVideos\\";
           ...
           try {
               ...
               boolean carga=bd.cargarVideos(codUsu,url);
               response.sendRedirect("home.jsp");
           } catch (Exception e) {
               out.print("No has cargado ningun video. Vuelve a tu <a href='home.jsp'>perfil</a>" );
           }
       %>
    </body>
</html>
