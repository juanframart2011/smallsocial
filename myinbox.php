       ...
       <div class="box box-primary" style="margin-top:6px;">
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                  ...
                  <!-- the inbox -->
                  <div id="therightinboxlst" class="col-md-4 col-sm-4 col-xs-4">
                    <?php conversationlstbig(); ?>
                  </div>
                  <div id="therightinboxcontent" class="col-md-8 col-sm-8 col-xs-8">
                     
                      <!-- conversation -->
                      <div id="conversation-body" class="col-md-12 col-sm-12 col-xs-12">
                         
                      </div>
                      <!-- conversation -->
                      <!-- form conversation -->
                      <div id="full-box-message" class="box-footer">
                         <form  method="post" class="formerchatfrmfull">
