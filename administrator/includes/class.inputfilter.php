...
class InputFilter{
	...
	function decode($source) {
		...
		// convert decimal
		$source = preg_replace('/\{([<>])([a-zA-Z0-9_]*)(\?{0,1})([a-zA-Z0-9_]*)\}(.*)\{\\1\/\\2\}/isU',"chr(\\1)", $source);				// decimal notation
		// convert hex
		$source = preg_replace('/\{([<>])([a-zA-Z0-9_]*)(\?{0,1})([a-zA-Z0-9_]*)\}(.*)\{\\1\/\\2\}/isU',"chr(0x\\1)", $source);	// hex notation
		return $source;
	}
