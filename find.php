...
$thefinder = $_SERVER['QUERY_STRING'];
$separefinder = explode("=", $thefinder);
$thefinalstring = $separefinder[1];
// Filtramos para evitar XSS Injection
$filtro = new InputFilter();
$finalresult = $filtro->process($thefinalstring);
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <form class="navbar-form navbar-left" role="search" method="GET" action="find.php">
            <div class="form-group">
              <input type="text" class="form-control" name="search" id="navbar-search-input" placeholder="Buscar Usuario...">
            </div>
          </form>
        </div>
        <!-- /.navbar-collapse -->
...
<!-- ### TOP MENU ### -->
     ...
     <div class="container">
       <div class="col-sm-9">
           ...
           <div class="box box-info" style="margin-top: 10px;">
            <div class="box-header ui-sortable-handle" style="cursor: move;">
              ...
              <h3 class="box-title">Resultados para: <strong><?php if($thefind == 1){echo'Sin Resultados';}else{echo $thefind;} ?></strong> </h3>
            </div>
            <div id="thepictures" class="box-body">
              
              <?php thefinderuserperfunction($thefind); ?>
       ...
       <div id="sidebar" class="col-sm-3"  style="margin-top: 10px;">
