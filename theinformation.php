...
<html lang="en">
  <head>
    ...
    <title>Información | MeeTeam</title>
              ...
              <div class="row">
                ...
                <div class="col-sm-8 border-right">
                  <div class="description-block" style="text-align:center;">
                      ...
                      <a  href="theinformation.php?<?php echo $thepermauser; ?>" class="infoprofilebtn btn btn-sm btn-default active"><i class="fa fa-info-circle"></i> Información</a>
          ...
          <div id="timeliner">
           ...
           <div class="box box-info">
            ...
            <div id="boxbodyinfo" class="box-body">
               ...
               <?php theinformation($explodedata[0]); ?>
